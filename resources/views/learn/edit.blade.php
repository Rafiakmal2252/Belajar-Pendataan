...
@section('content')
    <div class="pr-8 pt-20 sm:ml-56">
        ...
        <div class="p-6 bg-gray-900 text-white rounded-lg shadow-md">
            <h2 class="text-2xl font-semibold mb-4">Edit Kajian</h2>

            <form action="{{ route('learn.update', $learn->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1  gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" required value="{{ $learn->title }}"
                    ...
                    <div>
                        ...
                        <textarea id="summary" name="summary" required 
                            class="w-full mt-1 px-4 py-2 bg-gray-800 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 h-24">{{ $learn->summary }}</textarea>
                    </div>
                </div>
