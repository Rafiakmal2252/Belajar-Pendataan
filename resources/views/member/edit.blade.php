...
<div class="p-8 pt-24 sm:ml-64">
    ...
    <form action="{{ route('member.update', $member->id_rohis) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="id_rohis" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Rohis</label>
                <input type="text" id="id_rohis" name="id_rohis" value="{{ $member->id_rohis }}"
            ...
            <div>
                ...
                <input type="text" id="class" name="class" value="{{ $member->class }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            ...
            <div>
                ...
                <input type="text" id="nis" name="nis" value="{{ $member->nis }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
